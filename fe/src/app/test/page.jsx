  ...
  return (
    <div className="h-dvh flex flex-col">
      <div className="border-b border-r border-solid border-stone-300 flex ">
        <div className="flex grow gap-1 p-1.5 overflow-x-auto border border-solid border-gray-300">
      ...
      <div className="p-4 container mx-auto max-w-3xl flex flex-col grow">
        {/** question div */}
        <Question currentQuestion={fetchedData[currentQuestionIndex]} index={currentQuestionIndex} optionIndex={null}/>
